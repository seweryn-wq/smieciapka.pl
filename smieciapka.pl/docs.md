...
**smieciapka.pl** to progresywna aplikacja webowa (PWA) służąca do wyświetlania harmonogramu odbioru odpadów dla mieszkańców gminy Piaseczno i okolic. Aplikacja pokazuje jakie odpady są odbierane dzisiaj i jutro, oraz umożliwia przeglądanie pełnego harmonogramu.

### Główne funkcje:
- Wyświetlanie odpadów odbieranych dzisiaj i jutro
- Pełny harmonogram w widoku modalnym
...
| JSON | Format danych harmonogramów |
...
**Odpowiedzialność:** Wyświetlanie harmonogramu odbioru odpadów
...
| `displayWasteIcons(containerId, wasteTypes)` | Renderuje ikony odpadów |
...
**Elementy UI:**
- Nagłówek z nazwą miejscowości i ulicy
- Sekcja "Dzisiaj" z ikonami odpadów
- Sekcja "Jutro" z ikonami odpadów
- Przyciski akcji: kalendarz (📅), wyszukiwanie (🔍), ustawienia (⚙️)
...
```json
{
  ...
  "dates": {
    ...
    "papier": ["2025-12-04", "2026-01-03", ...],
    "szklo": ["2025-12-18", "2026-01-15", ...],
    "bio": ["2025-12-09", "2025-12-22", ...],
    "gabaryty": ["2026-01-26", "2026-04-20", ...],
    "choinki": ["2026-01-05", "2026-02-03"]
  }
}
```
